(function($) {
    ...
    $(".navbar-wrapper .mainmenunav .navbar .navbar-collapse .menu-item-has-children > a").on("click", function (e) {
		e.preventDefault();
    ...
    $(".nav-styletwo .navbar .navbar-nav").addClass("ml-auto");
    $(".nav-styletwo .navbar .navbar-nav .sub-menu").addClass("dropdown-menu");
    $(".nav-styletwo .navbar .navbar-nav .sub-menu li").addClass("dropdown-item");

    // DropDown menu fix show in hover

    $('.nav-styletwo .navbar .menu-item-has-children').hover(function () {
        $(this).find('.dropdown-menu').addClass('show');
    }, function () {
        $(this).find('.dropdown-menu').removeClass('show')
    });

    $('.nav-styletwo .navbar .dropdown-item').hover(function () {
    ...
    $(".nav-styletwo .nav-styletwo .navbar .menu-toggle").on("click", function () {
    ...
    function activeNavbar() {
        ...
        if ($(window).scrollTop() > 20) {
            $(".nav-styletwo").addClass("active-nav");
        } else {
            $(".nav-styletwo").removeClass("active-nav");
        }
